...
public class EntityFactory {
	...
	public enum EntityType {
		...
		COLLISION_ENTITY(CollisionEntityInanimate::new, EntityCollectionProvider.Type.FOCAL_POINT, Inanimate.class),
		COLLISION_TILE(CollisionTile::new, EntityCollectionProvider.Type.FOREGROUND, Tile.class),
		...
		ENTITY_ANIMATE(EntityAnimate::new, EntityCollectionProvider.Type.FOCAL_POINT, Animate.class),
		ENTITY_INANIMATE(EntityInanimate::new, EntityCollectionProvider.Type.FOCAL_POINT, Inanimate.class),
		...
		PLAYER(Player::new, EntityCollectionProvider.Type.FOCAL_POINT, Animate.class),
		//STARS(Stars::new, Stars::new, EntityGroupProvider.Type.SKY),
		STATIC_BACKGROUND(StaticBackground::new, EntityCollectionProvider.Type.STATIC_BACKGROUND, Inanimate.class),
