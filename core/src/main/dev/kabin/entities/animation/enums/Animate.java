...
import dev.kabin.entities.animation.AnimationMetadata;
...
public enum Animate {
    ...
    private static final EnumMap<dev.kabin.entities.animation.enums.Animate, AnimationMetadata> METADATA_MAP = Arrays
