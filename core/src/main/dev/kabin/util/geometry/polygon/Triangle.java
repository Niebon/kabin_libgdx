...
public interface Triangle {
	...
	static TriangleImpl of(
		...
		var e1 = new SegmentImpl(p1, p2);
		var e2 = new SegmentImpl(p2, p3);
		var e3 = new SegmentImpl(p3, p1);

		return new TriangleImpl(e1, e2, e3);
	}

	static TriangleImpl of(float x1, float y1,
						   float x2, float y2,
						   float x3, float y3) {
		var p1 = new PointImpl(x1, y1);
		var p2 = new PointImpl(x2, y2);
		var p3 = new PointImpl(x3, y3);
