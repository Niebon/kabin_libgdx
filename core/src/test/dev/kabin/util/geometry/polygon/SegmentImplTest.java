...
class SegmentImplTest {
	...
	void intersects_disjoint1() {
		var s1 = Segment.of(-1, 0, 1, 0);
		var s2 = Segment.of(2, 0, 3, 0);
	...
	void intersects_disjoint2() {
		var s1 = Segment.of(0, -1, 0, 1);
		var s2 = Segment.of(0, 2, 0, 3);
		Assertions.assertFalse(s1.intersects(s2));
		Assertions.assertFalse(s2.intersects(s1));
	}
	...
	@Test
	void isJoined() {
		var s1 = Segment.of(0, 0, 1, 1);
		var t1 = Segment.of(1, 1, 2, 2);
